import os
from utils.dataprocess import souped, suffix
from utils.city import City
from pypinyin import lazy_pinyin



#fetch the list of weather forcast url for every city in province
#input: province name
...
def save_to_csvfile(city_list : list[City], folderpath=os.getcwd()):
